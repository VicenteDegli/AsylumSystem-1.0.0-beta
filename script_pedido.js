        <script language="JavaScript">
				...
				function validarRadio(ctrl){			
					...
					alert("Favor selecionar em todos o campos radio.");
					return false;
				}
				...
				function check(){			
					if(validarString(document.form1.idos_nome.value) &&            
						 ...
						 validarString(document.form1.pedi_ende_referencia.value) &&
						 validarString(document.form1.pedi_tipo_servico.value) &&
						 verificarData(document.form1.pedi_date.value) &&
						 validarString(document.form1.pedi_email.value)){
