        ...
        <a href='index.php'><img src='imagens/logout.gif' align ='bottom' id='imgpos' border='0px' title='Sair do Sistema'><p></a>
      	<div id="principal">
			...
			<?php
						...
						echo "<form name='form_if' action='documentos_cadastrados.php?docu_id=$docu_id&amp;docu_identidade=$docu_identidade&amp;docu_cart_trabalho=$docu_cart_trabalho&amp;docu_titulo=$docu_titulo' method='post'>";
						...
						if($docu_identidade==1){
							...
							?>
								<input type='text' name='numero_rg' size='22%' maxlength="12" OnKeyPress="formatar(this, '##.###.###-#')">
                    		<?php
							echo "</span>";
							echo "<span class='forms'>";
								echo "Orgão Expeditor:<small>*</small><br>";
								echo "<input type='text' name='org_exp' size='22%'>";
							echo "</span>";
						}
						if($docu_cart_trabalho==1){
							...
							echo "<span class='forms'>";
								echo"Número:<small>*</small><br>";
								echo "<input type='text' name='numero_cart' size='22%'>";
							echo "</span>";
							echo "<span class='forms'>";
								echo "Série:<small>*</small><br>";
								echo "<input type='text' name='serie' size='22%'>";
							echo "</span>";
						}
						if($docu_titulo==1){
							echo "<span class='coluna_x4'>";
							...
							echo "<span class='forms'>";
								echo"Número:<small>*</small><br>";
								echo "<input type='text' name='numero_titulo' size='22%'>";
							echo "</span>";
							echo "<span class='forms'>";
								echo "Zona:<small>*</small><br>";
								echo "<input type='text' name='zona' size='22%'>";
							echo "</span>";
							echo "<span class='forms'>";
								echo "Seção:<small>*</small><br>";
								echo "<input type='text' name='secao' size='22%'>";
							echo "</span>";
						}
						...
						echo "<div id='linkis_fixos'>
							<img src='imagens/cadastrar.gif' border='0px' onclick='selecionarFuncoes()' style='cursor:pointer'/>
						</div>";
			?>
            </div>
        	<div id="esquerda"></div>
